package kr.hs.emirim.w2009.ex10_19_29;
        ...
        public void onClick(View v) {
            ...
            switch(v.getId()){
                ...
                case R.id.btn_homepage:
                    ...
                    break;
                case R.id.btn_map:
                    uri = Uri.parse("https://www.google.co.kr/maps?q="+ 37.46675595309878 + "," + 126.93285435336598);
                    intent = new Intent(Intent.ACTION_VIEW, uri);
                    break;
                case R.id.btn_search:
                    ...
                    break;
                case R.id.btn_sms:
                    uri = Uri.parse("smsmto:" + Uri.encode("010-5555-1111"));
